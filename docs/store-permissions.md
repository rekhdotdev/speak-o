...
No analytics, tracking, remote configuration, remotely hosted code, or automatic diagnostic upload is present. The canonical privacy policy is hosted at `https://rekh.dev/speak-o/privacy/`.
